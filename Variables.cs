...
namespace PetRegistry
{
    public static class Variables
    {
        ...
        public static Dictionary<string, string[]> MatchingRoles = new Dictionary<string, string[]>
        {
            ...
            ["открытие карточки"] = new string[] { "Ветврач", "Оператор приюта", "Куратор ВетСлужбы", "Куратор ОМСУ", "Оператор ВетСлужбы", "Оператор ОМСУ", "Подписант ВетСлужбы", "Подписант ОМСУ" },
